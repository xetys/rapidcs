...
-->
{sprintf($LNG.fleet_combatline1,$RoundInfo.info[4]|number,$RoundInfo.info[0]|number,$RoundInfo.info[3]|number)}<br>
{sprintf($LNG.fleet_combatline2,$RoundInfo.info[5]|number,$RoundInfo.info[2]|number,$RoundInfo.info[1]|number)}<br><br>
{/if}
{/foreach}
<br><br>
{if $Raport.result == "a"}
